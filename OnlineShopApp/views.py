...
from OnlineShopApp.models import Product,OrderUpdate,Orders
...
def productView(request, myid):
    ...
    return render(request, 'OnlineShopApp/prodView.html', {'product':product[0]})
...
def checkout(request):
    if request.method=="POST":
        ...
        thank = True
        id = order.order_id
        return render(request, 'OnlineShopApp/checkout.html', {'thank':thank, 'id': id})
